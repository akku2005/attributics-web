        ...
        <section id="about">
            ...
            >
                <div className="grid grid-cols-1 lg:grid-cols-[4fr_6fr] gap-12 lg:gap-22 items-center hyphens-none">
                    ...
                    <motion.div 
                        className="w-full h-72 sm:h-96 lg:h-155"
                        initial={{ opacity: 0, y: 15 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
            ...
            {/* STATEMENT */}
            <motion.div 
                className="mb-25 rounded-2xl rounded-[20px] py-1 text-center lg:px-[5%] hyphens-none"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: "-100px" }}
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <motion.ul 
                            className="list-none space-y-2 pl-20"
                            initial="hidden"
                            whileInView="visible"
                            viewport={{ once: true }}
                            variants={{
                        ...
                        >
                            {vision.vissionMission.mission.points.map((item, idx) => (
                                <motion.li 
                                    key={idx} 
                                    className="section-description relative before:content-['➤'] before:text-black-500 before:absolute before:-left-7"
                                    variants={{
        ...
        >
            <div className="grid grid-cols-2 gap-6 items-start w-full lg:flex lg:justify-between">
                {metricCards.map((card, index) => (
                    <motion.div
                        key={index}
                        className="rounded-2xl py-4 w-full flex flex-col items-center text-center gap-2"
                        initial={{ opacity: 0, y: 15 }}
