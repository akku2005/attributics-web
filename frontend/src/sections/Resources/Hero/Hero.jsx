    ...
    return (
      <Block xpad="large">
        <section className="lg:pb-10 pb-6">
          <div className="relative rounded-xl overflow-hidden bg-[#F5F5F5] animate-pulse">
            <div className="flex flex-col lg:flex-row">
  
              {/* Image Skeleton */}
              <div className="lg:w-1/2 h-60 lg:h-90 bg-gray-300" />
  
              {/* Content Skeleton */}
              <div className="lg:w-1/2 p-6 sm:p-8 lg:p-10 flex flex-col justify-center space-y-4">
