...
const CareersPage = () => {
    ...
    return (
        <>
            {/* Hero + Team Section */}
            <section className="pt-40 lg:pt-48 pb-16 lg:pb-24 bg-white">
                <Container>
                    {/* Eyebrow + Heading */}
                ...
                <div className="relative">
                    <div
                        ref={scrollRef}
                        className="flex gap-4 overflow-x-auto scrollbar-hide px-4 sm:px-6 lg:px-8 xl:px-[calc((100vw-1280px)/2+2rem)]"
                    >
                        {team.members.map((member, index) => (
                            <div
                                key={index}
                                className="flex-shrink-0 w-[160px] sm:w-[180px] lg:w-[200px] aspect-[3/4] rounded-[10px] overflow-hidden relative cursor-pointer group"
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-out" />
            ...
            <section className="pb-16 lg:pb-24 bg-white">
                <Container>
                    <div className="flex justify-center">
                        <div className="border border-[#E0E0E0] rounded-[12px] px-8 py-10 sm:px-12 sm:py-12 text-center max-w-xl w-full">
                            <h2
                                className="uppercase text-sm sm:text-base tracking-[0.1em] font-semibold text-[#131212] mb-4"
                                style={{ fontFamily: "'IBM Plex Mono', monospace" }}
                            >
                                WORK FOR THE FUTURE!
                            </h2>
                            ...
                            <a
                                href="/contact"
                                className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-[#131212] text-white text-sm font-medium rounded-[6px] hover:bg-[#333] active:scale-95 transition-all duration-200"
                                style={{ fontFamily: "'IBM Plex Sans', sans-serif" }}
                            >
                                Join us <span>→</span>
                            </a>
