    ...
    return (
        <section id="about" className="py-16 lg:py-24 bg-white mt-10">
            ...
            <div className="relative w-full max-w-[1440px] mx-auto px-[163px]">
                ...
                <div className="relative min-w-[1105px] min-h-[210px] w-full max-w-[1440px] text-center mb-24">
                ...
                {/* Who Are We Section - Group 99: 1113px × 468px */}
                <div className="relative w-full min-w-[1067px] min-h-[468px] max-w-[1113px]">
                    {/* Grid Layout for Side-by-Side */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-[128px] items-start h-full">
                        {/* Right Image - 473px × 468px */}
                        <div className="w-[473px] h-[468px]">
             ...
             {/* Metrics Section */}
             <div className="mx-auto px-[163px] relative w-full max-w-[1376px] min-h-[600px] lg:h-[539px] overflow-hidden mb-8 lg:mb-12 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                    ...
                    {/* White Card Overlay */}
                    <div className="absolute min-w-[1289px] min-h-[271px] top-[204px] left-[44px]
                        ...
                        <div className='flex items-center justify-between w-full'>
                            {metricCards.map((card, index) => (
                                <div
                                    key={index}
                                    className="min-w-[146px] min-h-[130px] flex flex-col items-center justify-center text-center"
                                >
                                    {/* Headline */}
                                    <p
                                        className="
